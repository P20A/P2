...
urlpatterns = [
    ...
    path('users/' ,views.ShowUsersView.as_view(),name='show_users'),
    path('reset/',views.UserPasswordResetView.as_view(),name='reset_password'),
    path('reset/done/',views.UserPasswordResetDoneView.as_view(), name='password_reset_done'),
    path('confirm/<uidb64>/<token>/',views.UserPasswordResetConfrimView.as_view(), name='password_reset_confirm'),
